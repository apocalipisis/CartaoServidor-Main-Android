...
import com.example.appcartaoservidorv1.databinding.FragmentComercianteVendaSenhaBinding
import com.example.appcartaoservidorv1.services.utilidades.BaseFragment
import com.example.appcartaoservidorv1.services.utilidades.fromInserirsenhaToComerciante
import com.example.appcartaoservidorv1.services.utilidades.fromInserirsenhaToStatusvenda
...
class VendaSenha : BaseFragment() {
    // Variavel responsavel pelo binding
    lateinit var binding: FragmentComercianteVendaSenhaBinding
    lateinit var args: VendaSenhaArgs
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_comerciante_venda_senha,
                container,
                false
            )
        // Recupera as variaveis passada para a view
        args = VendaSenhaArgs.fromBundle(requireArguments())
        ...
        binding.btnAvancar.setOnClickListener {
            viewModel.senhaCompleta.value?.let { it1 ->
                fromInserirsenhaToStatusvenda(
                    ...
                    it1, viewModel.numeroCartao, viewModel.nomeComerciante, viewModel.token
                )
            }
        }
