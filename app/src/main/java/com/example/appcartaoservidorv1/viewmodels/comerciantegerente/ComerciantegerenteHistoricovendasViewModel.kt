...
class ComerciantegerenteHistoricovendasViewModel(val matricula: String, val token: String) :
    ViewModel() {
...
class ComerciantegerenteHistoricovendasViewModelFactory(
    private val matriculaMae: String,
    private val token: String,
) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ComerciantegerenteHistoricovendasViewModel::class.java)) {
            return ComerciantegerenteHistoricovendasViewModel(matriculaMae, token) as T
        }
