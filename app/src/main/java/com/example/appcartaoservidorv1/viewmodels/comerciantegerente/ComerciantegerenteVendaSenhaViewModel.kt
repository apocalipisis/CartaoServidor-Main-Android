...
class ComerciantegerenteVendaSenhaViewModel(
...
class ComerciantegerenteVendaSenhaViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ComerciantegerenteVendaSenhaViewModel::class.java)) {
            return ComerciantegerenteVendaSenhaViewModel(
                matriculaCliente,
                nomeCliente,
                valor,
