...
class ComeciantegerenteDetalhestransacaoViewModel (val transacao: Transacao): ViewModel() {
...
class ComeciantegerenteDetalhestransacaoViewModelFactory(private val transacao: Transacao) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ComeciantegerenteDetalhestransacaoViewModel::class.java)) {
            return ComeciantegerenteDetalhestransacaoViewModel(transacao) as T
        }
