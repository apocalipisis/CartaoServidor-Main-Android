...
class FuncionariocomerciantedetalhesViewModel(val funcionario: Funcionario, val token:String): ViewModel() {
}


// Configura a factory do ViewModel (Usada para receber os parametros passados para o viewmodel)
class FuncionariocomerciantedetalhesViewModelFactory(private val funcionario: Funcionario, private val token:String) : ViewModelProvider.Factory {
