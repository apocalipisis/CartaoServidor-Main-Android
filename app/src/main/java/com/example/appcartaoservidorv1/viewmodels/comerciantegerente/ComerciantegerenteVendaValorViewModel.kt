...
class ComerciantegerenteVendaValorViewModel(
...
class ComerciantegerenteVendaValorViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ComerciantegerenteVendaValorViewModel::class.java)) {
            return ComerciantegerenteVendaValorViewModel(
