...
class ComercianteFuncionarioVendaStatusViewModel (
    ...
    private fun inserirTransacao(
        ...
        viewModelScope.launch {
            ...
            try {
                response = APIComercianteFuncionario.APIComercianteFuncionarioService.inserirVendaComercianteFuncionario(
                    matriculaCliente,
                    matriculaComerciante,
                    matriculaVendedor,
                    valor.toString(),
...
class ComercianteFuncionarioVendaStatusViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(ComercianteFuncionarioVendaStatusViewModel::class.java)) {
            return ComercianteFuncionarioVendaStatusViewModel(
                matriculaCliente,
                matriculaComerciante,
                matriculaVendedor,
                valor,
