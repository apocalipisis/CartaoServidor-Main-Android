...
class AdapterComerciantefuncionarioHistoricoVendas (val clickListener: Transacao_Listener) :
    ...
    class TextViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        companion object {
            fun from(parent: ViewGroup): TextViewHolder {
                ...
                val view = layoutInflater.inflate(R.layout.header_comerciantefuncionario_vendas, parent, false)
