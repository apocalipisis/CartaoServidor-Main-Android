...
class DialogComercianteDetalhestransacaoViewModel(val transacao: Transacao) : ViewModel() {
...
class DialogComercianteDetalhestransacaoViewModelFactory(private val transacao: Transacao) :
    ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(DialogComercianteDetalhestransacaoViewModel::class.java)) {
            return DialogComercianteDetalhestransacaoViewModel(transacao) as T
        }
