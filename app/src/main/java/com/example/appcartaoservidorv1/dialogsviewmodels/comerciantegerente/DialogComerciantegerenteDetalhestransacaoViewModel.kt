...
class DialogComerciantegerenteDetalhestransacaoViewModel(val transacao: Transacao) : ViewModel() {
...
class DialogComerciantegerenteDetalhestransacaoViewModelFactory(private val transacao: Transacao) :
    ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(DialogComerciantegerenteDetalhestransacaoViewModel::class.java)) {
            return DialogComerciantegerenteDetalhestransacaoViewModel(transacao) as T
        }
